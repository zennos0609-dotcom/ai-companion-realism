...
published: false
description: A stronger model writes sweeter dialogue. But it can also make a worse relationship. Full transcripts from two small AI companion tests.
...
Full notes and transcripts:

- [AI Companion Realism Notes](https://github.com/zennos0609-dotcom/ai-companion-realism)
